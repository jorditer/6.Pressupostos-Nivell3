...
const BudgetNavBar: React.FC<BudgetNavBarProps> = ({ hidden, sortByDateAsc,sortByDateDesc, sortByName, sortByTotal }) => {
  ...
  return (
    <div className={ `${hidden} gap-x-4 pe-3 flex md:justify-end items-center justify-evenly` }>
      <div className="budget-search flex px-4 bg-orange-50 py-3 rounded-md border-2 border-orange-500 overflow-hidden max-w-md font-[sans-serif]">
      ...
      <div className="flex space-x-4">
		...
		onClick={() => handleButtonClick('Data', sortByDateAsc)}
		  >
          Data
        </button>
        <button
